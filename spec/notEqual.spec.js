...
describe("notEqual() without message", function () {
    beforeEach(function (done) {
        transformHelper("./spec/fixtures/notEqual_no_message.js", function (err, result) {
            if (err) throw err;
    ...
    it("should transform callee into assert.notEqual()", function () {
...
describe("notEqual() with message", function () {
    beforeEach(function (done) {
        transformHelper("./spec/fixtures/notEqual_with_message.js", function (err, result) {
            if (err) throw err;
            this.result = result.body[0].expression;
            done();
        }.bind(this));
