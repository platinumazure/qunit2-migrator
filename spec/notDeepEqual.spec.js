...
describe("notDeepEqual() without message", function () {
    beforeEach(function (done) {
        transformHelper("./spec/fixtures/notDeepEqual_no_message.js", function (err, result) {
            if (err) throw err;
    ...
    it("should transform callee into assert.notDeepEqual()", function () {
...
describe("notDeepEqual() with message", function () {
    beforeEach(function (done) {
        transformHelper("./spec/fixtures/notDeepEqual_with_message.js", function (err, result) {
            if (err) throw err;
            this.result = result.body[0].expression;
            done();
        }.bind(this));
