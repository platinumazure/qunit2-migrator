...
describe("propEqual() without message", function () {
    beforeEach(function (done) {
        transformHelper("./spec/fixtures/propEqual_no_message.js", function (err, result) {
            if (err) throw err;
    ...
    it("should transform callee into assert.propEqual()", function () {
...
describe("propEqual() with message", function () {
    beforeEach(function (done) {
        transformHelper("./spec/fixtures/propEqual_with_message.js", function (err, result) {
            if (err) throw err;
            this.result = result.body[0].expression;
            done();
        }.bind(this));
