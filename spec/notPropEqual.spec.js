...
describe("notPropEqual() without message", function () {
    beforeEach(function (done) {
        transformHelper("./spec/fixtures/notPropEqual_no_message.js", function (err, result) {
            if (err) throw err;
    ...
    it("should transform callee into assert.notPropEqual()", function () {
...
describe("notPropEqual() with message", function () {
    beforeEach(function (done) {
        transformHelper("./spec/fixtures/notPropEqual_with_message.js", function (err, result) {
            if (err) throw err;
            this.result = result.body[0].expression;
            done();
        }.bind(this));
