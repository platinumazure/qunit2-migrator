...
describe("strictEqual() without message", function () {
    beforeEach(function (done) {
        transformHelper("./spec/fixtures/strictEqual_no_message.js", function (err, result) {
            if (err) throw err;
    ...
    it("should transform callee into assert.strictEqual()", function () {
...
describe("strictEqual() with message", function () {
    beforeEach(function (done) {
        transformHelper("./spec/fixtures/strictEqual_with_message.js", function (err, result) {
            if (err) throw err;
            this.result = result.body[0].expression;
            done();
        }.bind(this));
