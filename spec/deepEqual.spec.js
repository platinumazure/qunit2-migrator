...
describe("deepEqual() without message", function () {
    beforeEach(function (done) {
        transformHelper("./spec/fixtures/deepEqual_no_message.js", function (err, result) {
            if (err) throw err;
    ...
    it("should transform callee into assert.deepEqual()", function () {
...
describe("deepEqual() with message", function () {
    beforeEach(function (done) {
        transformHelper("./spec/fixtures/deepEqual_with_message.js", function (err, result) {
            if (err) throw err;
            this.result = result.body[0].expression;
            done();
        }.bind(this));
